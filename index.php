            ...
            <tbody>
                ...
                foreach ($ogrenciler as $ogrenci) {
                    echo "<tr>
                            ...
                            <td>
                                <a href='ogrenci_detay.php?id={$ogrenci['id']}' class='btn btn-info btn-sm'><i class='bi bi-info-circle'></i> Detay</a>
                                <a href='ogrenci_duzenle.php?id={$ogrenci['id']}' class='btn btn-warning btn-sm'><i class='bi bi-pencil-square'></i> Düzenle</a>
                                <a href='ogrenci_sil.php?id={$ogrenci['id']}' class='btn btn-danger btn-sm'><i class='bi bi-trash'></i> Sil</a>
                            </td>
                        </tr>";
                }
                ?>
...
<footer class="bg-dark text-white py-4">
    <div class="container d-flex justify-content-between">
        <div>
            <p><i class="bi bi-telephone"></i> 551 745 1968 | <i class="bi bi-globe2"></i> aliihsannaslı.com.tr</p>
        </div>


        <div class="row">
            <form id="contactForm" action="phpmail/index.php" method="POST">
	        <div class="row">
		    <div class="form-group">
			<div class="col-md-12">
			    <input type="text" placeholder="Adınız Soyadınız" value="" data-msg-required="Please enter your name." maxlength="100" class="form-control input-lg" name="name" id="name" required>
			</div>
		    </div>
		</div>
		<div class="row">
		    <div class="form-group">
			<div class="col-md-12">
		            <input type="email" placeholder="E-mail Adresiniz" value="" data-msg-required="Your email address." data-msg-email="Geçerli bir mail giriniz..." maxlength="200" class="form-control input-lg" name="email" id="email" required>
			</div>
		    </div>
		</div>
		<div class="row">
		...
		<div class="row">
		    <div class="form-group">
			<div class="col-md-12">
			    <textarea maxlength="5000" placeholder="Mesajınızı buraya yazabilirsiniz" data-msg-required="Please enter your message." rows="5" class="form-control input-lg" name="message" id="message" required></textarea>
			</div>
		    </div>
		</div>
		<div class="row">
		    <div class="col-md-12">
			<input type="submit" name="iletisimform" value="Mesajı Gönder" class="btn btn-primary btn-md mb-sm" data-loading-text="Loading...">
		    </div>
		</div>
	    </form>
        </div>
